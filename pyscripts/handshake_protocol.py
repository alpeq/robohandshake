...
def test_motor_registers():
    ...
    print(handmotor_sub.packetHandler.read4ByteTxRx(handmotor_sub.portHandler, PROTOCOL_VERSION, id_motor, ADDR_OPERATING_MODE))
    print(handmotor_sub.packetHandler.read4ByteTxRx(handmotor_sub.portHandler, PROTOCOL_VERSION, id_motor, ADDR_GOAL_CURRENT))
